...
// global.redisCache = new Redis(process.env.REDIS_PORT, process.env.REDIS_HOST);
global.redisCache = new Redis(6379, "65.1.55.119");
...
const whitelist = process.env.CORS_WHITELIST_URLS.split(",").map((url) =>
  url.trim()
);
